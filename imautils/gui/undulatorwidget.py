...
#
# class UndulatorWidget(_QWidget):
#     """Creates new configuration list in undulator database."""
#
#     def __init__(self, parent=None):
#         """Set up the ui."""
#         super().__init__(parent)
...
#                     self.status['CID_motion_state'] == 1)
#
#                 self.ui.lbl_csd_lim_p.setEnabled(self.status['CSD_pos_lim'])
#                 self.ui.lbl_cse_lim_p.setEnabled(self.status['CSE_pos_lim'])
#                 self.ui.lbl_cie_lim_p.setEnabled(self.status['CIE_pos_lim'])
#                 self.ui.lbl_cid_lim_p.setEnabled(self.status['CID_pos_lim'])
#
#                 self.ui.lbl_csd_lim_n.setEnabled(self.status['CSD_neg_lim'])
#                 self.ui.lbl_cse_lim_n.setEnabled(self.status['CSE_neg_lim'])
#                 self.ui.lbl_cie_lim_n.setEnabled(self.status['CIE_neg_lim'])
#                 self.ui.lbl_cid_lim_n.setEnabled(self.status['CID_neg_lim'])
#
#                 self.ui.lbl_csd_kill_p.setEnabled(self.status['CSD_pos_kill'])
#                 self.ui.lbl_cse_kill_p.setEnabled(self.status['CSE_pos_kill'])
#                 self.ui.lbl_cie_kill_p.setEnabled(self.status['CIE_pos_kill'])
...
#
#         if _coupling == 0:
#             self.und.move_phase(_rel_pos)
#         elif _coupling == 1:
#             self.und.move_counterphase(_rel_pos)
#         elif _coupling == 2:
#             self.und.move_gv(_rel_pos)
#         elif _coupling == 3:
#             self.und.move_gh(_rel_pos)
#         elif _coupling == 4:
#             self.und.move_csd(_rel_pos)
#         elif _coupling == 5:
#             self.und.move_cse(_rel_pos)
#         elif _coupling == 6:
#             self.und.move_cie(_rel_pos)
#         elif _coupling == 7:
#             self.und.move_cid(_rel_pos)
#         elif _coupling == 8:
#             self.und.move_all(_rel_pos)
#
#         self.update_flag = True
#
#     def stop(self):
